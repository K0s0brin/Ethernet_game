...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  */
    ...
    PeriphClkInitStruct.PLL3.PLL3M = 5;      /* 25 MHz HSE / 5   = 5 MHz    */
    PeriphClkInitStruct.PLL3.PLL3N = 160;    /* 5 MHz * 160      = 800 MHz  */
    PeriphClkInitStruct.PLL3.PLL3P = 2;
    PeriphClkInitStruct.PLL3.PLL3Q = 2;
    PeriphClkInitStruct.PLL3.PLL3R = 83;     /* 800 MHz / 83     = 9.63 MHz */
    PeriphClkInitStruct.PLL3.PLL3RGE = RCC_PLL3VCIRANGE_2;   /* 4-8 MHz in  */
    PeriphClkInitStruct.PLL3.PLL3VCOSEL = RCC_PLL3VCOWIDE;   /* 192-836 MHz */
